...
namespace laba3
{
    public partial class Form1 : Form
    {
        ...
        private void SobelFilterBtn_Click(object sender, EventArgs e)
        {
            double limit = Convert.ToDouble(parameterTextBox.Text);
            SobelFilter sobelFilter = new SobelFilter(Convert.ToInt32(limit));
            outputPictureBox.Image = sobelFilter.Filter(_sourcePicture);
        }
    }
}
